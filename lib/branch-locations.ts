...
/** Update lat/lng to your real office coordinates from Google Maps. */

export const BRANCH_LOCATIONS: BranchLocation[] = [

  { name: "Manila Main Branch", lat: 14.5547, lng: 121.0244, radiusMeters: 200 },

  { name: "Davao Branch", lat: 7.1907, lng: 125.4553, radiusMeters: 200 },
